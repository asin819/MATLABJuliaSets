...
c1 = 0.34 - 0.05i; % Complex value for generating our starting Julia set
c2 = 0 + 0.8i; % Complex value for generating our ending Julia set
...
if strcmpi(response(1),'y')
    ...
    colourmap = hot(cutoff); % use a built in colour map, feel free to try different ones
